...
class App extends Component {
    render() {
        return (
            ...
            <div className="main"  style={{border:'2px solid black',width:300,height:490,background:'grey',borderRadius:25}} >
                ...
                <div className="inputtext">
                    <input type="text" style={{marginLeft:-300}} placeholder="Message"/>               
                </div>
                <div className="tag3">
