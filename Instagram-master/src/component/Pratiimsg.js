    ...
    render() {
        return (
            ...
            <div className="main" style={{border:'2px solid black',width:300,height:490,background:'grey',borderRadius:25}}><br/>
                ...
                <div className="chat1" style={{width:100,marginLeft:190}}>
                    Hey!! Hapieee Birthdayyy
                </div>
                <div className="chat2" style={{width:100}}>
                    Thank you soo muchh!!! 
                </div>   
                <div className="chat3" style={{width:100,padding:10}}>
                ...
                <div className="tag2"  style={{marginTop:100}}>
