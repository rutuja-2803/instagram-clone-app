...
class App extends Component {
    render() {
        return (
            ...
            <div className="main" style={{border:'2px solid black',width:300,height:490,background:'grey',borderRadius:25}}><br/>
                ...
                <div className="chat1" style={{width:80}}>
                    Morning!
                </div><br/>
                <div className="chat2" style={{width:100}}>
                    Good Morning.
                </div>    <br/>
                <div className="chat3" style={{width:115,marginRight:50}}>
                    Had Breakfast??    
                </div>  <br/>
                <div className="chat2">
                    Yupp!!
                ...
                <div className="tag2 ctQZ" style={{marginTop:140}}>
                ...
                <div  style={{marginLeft:40,marginTop:140}}>
                    <input type="text" placeholder="Message"/>               
                </div>
                <div className="tag3" style={{marginLeft:180}}>
                ...
                <div className="tag4" style={{marginLeft:250,marginTop:-28}}>
